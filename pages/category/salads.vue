<template>
  <div class="salads-container">
    <h1>Салаты</h1>
    <div class="salads-container__cards">
      <div class="salads-container__card" v-for="(item,index) in filteredRecipes" :key="index">
